...
@lazySingleton
class PutSummaryAuditUseCase extends UseCase<SummaryAudit, SummaryAudit> {
  final ProsesOpnameRepository _repository;
  PutSummaryAuditUseCase(@Named("prosesOpnameRepository") this._repository);

  @override
  Future<Either<Failure, SummaryAudit>> call(SummaryAudit params) async {
    return await _repository.putSummary(params);
  }
}
