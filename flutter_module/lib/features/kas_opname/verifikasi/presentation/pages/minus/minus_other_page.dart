...
class MinusOtherPage extends StatefulWidget {
  const MinusOtherPage({Key? key}) : super(key: key);

  @override
  State<MinusOtherPage> createState() => _MinusOtherPageState();
}

class _MinusOtherPageState extends State<MinusOtherPage>
      ...
      child: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            TextFieldWidget(
              label: "Nominal",
              hint: "Input nominal penyebab minus",
            ...
            SizedBox(
              ...
              child: TextFieldWidget(
                expands: true,
                label: "Keterangan",
                hint: "Input penyebab brankas minus",
                ...
                onPressed: () {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    showDialogMessage(
                      ...
                      cancelLabel: "Tidak",
                      onProcess: () {
                        final params = MinusOther(
                          kdtk: kdtk,
                          nominal: _nominal.text.fromCurrencyFormat,
                          keterangan: _description.text,
                        );
                        context
